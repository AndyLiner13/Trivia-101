...
import { imgLightMode, imgDarkMode, imgLogout } from "./svg-gxrfv";
...
export default function Frame81() {
  return (
    <div className="bg-center bg-cover bg-no-repeat relative size-full" style={{ backgroundImage: `url('${imgFrame81}')` }}>
      <Frame123 />
    </div>
  );
}