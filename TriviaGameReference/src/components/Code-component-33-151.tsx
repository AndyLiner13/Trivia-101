...
export function KahootInterface({ questionNumber = 6 }: KahootInterfaceProps) {
  ...
  return (
    <div className="w-[800px] h-[450px] bg-gray-100 relative overflow-hidden rounded-lg">
      {/* Header with inline Question Number and Question Text */}
      <div className="absolute top-4 left-0 right-0 px-8 bg-gray-100">
      ...
      <div className="absolute top-28 left-1/2 transform -translate-x-1/2">
        <div className="bg-white rounded-lg shadow-lg p-3 inline-flex">
          <ImageWithFallback
      ...
      <div className="absolute bottom-4 left-0 right-0 grid grid-cols-2 gap-4 px-6 h-32">
        {/* Red Answer */}
        <button className="bg-red-600 hover:bg-red-700 text-white rounded-lg flex items-center gap-3 px-4 py-3 transition-colors">
        ...
        {/* Blue Answer */}
        <button className="bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center gap-3 px-4 py-3 transition-colors">
        ...
        {/* Yellow Answer */}
        <button className="bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg flex items-center gap-3 px-4 py-3 transition-colors">
        ...
        {/* Green Answer */}
        <button className="bg-green-500 hover:bg-green-600 text-white rounded-lg flex items-center gap-3 px-4 py-3 transition-colors">
