...
function Frame87() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-2 items-start justify-start left-0 p-[8px] bottom-0 w-[223px]">
...
export default function Frame125() {
  return (
    <div className="bg-center bg-cover bg-no-repeat relative w-[223px] h-[442px]" style={{ backgroundImage: `url('${imgFrame125}')` }}>
      <Frame80 />
