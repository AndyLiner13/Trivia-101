...
function Frame84() {
  return (
    <div className="[grid-area:2_/_1] bg-[#2773ea] relative rounded-[16px] shadow-[0px_0px_9.6px_0px_rgba(0,0,0,0.21)] shrink-0">
      <div className="flex flex-col items-center justify-center relative size-full">
...
export default function Frame129() {
  return (
    <div className="bg-center bg-cover bg-no-repeat relative size-full" style={{ backgroundImage: `url('${imgFrame129}')` }}>
      <Frame123 />
    </div>
  );
}